...
import { generateFileName, renderTemplate } from './file-utils.mjs';
import {
  formatDate,
  formatDays,
  formatDaysLong,
...
import { getTimetableGeoJSON, getAgencyGeoJSON } from './geojson-utils.mjs';
import {
  fromGTFSDate,
  toGTFSDate,
...
import { formatTripNameForCSV } from './template-functions.mjs';
...
export const getTimetablesListData = async (config) => {
